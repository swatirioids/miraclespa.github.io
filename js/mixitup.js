...
if (! function(t, e) {
        "use strict";
        t.MixItUp = function() {
            this._execAction("_constructor", 0), t.extend(this, {
                selectors: {
                    target: ".mix",
                    filter: ".filter",
                    sort: ".sort"
            ...
            _init: function(e, i) {
                ...
                if (a._execAction("_init", 0, arguments), i && t.extend(!0, a, i), a._$body = t("body"), a._domNode = e, a._$container = t(e), a._$container.addClass(a.layout.containerClass), a._id = e.id, a._platformDetect(), a._brake = a._getPrefixedCSS("transition", "none"), a._refresh(!0), a._$parent = a._$targets.parent().length ? a._$targets.parent() : a._$container, a.load.sort && (a._newSort = a._parseSort(a.load.sort), a._newSortString = a.load.sort, a._activeSort = a.load.sort, a._sort(), a._printSort()), a._activeFilter = "all" === a.load.filter ? a.selectors.target : "none" === a.load.filter ? "" : a.load.filter, a.controls.enable && a._bindHandlers(), a.controls.toggleFilterButtons) {
                    a._buildToggleArray();
                    for (var r = 0; r < a._toggleArray.length; r++) a._updateControls({
                        filter: a._toggleArray[r],
                        sort: a._activeSort
                    }, !0)
            ...
            _bindHandlers: function() {
                ...
                i._execAction("_bindHandlers", 0), i.controls.live ? i._$body.on("click.mixItUp." + i._id, i.selectors.sort, function() {
                    ...
                    i._processClick(t(this), "filter")
                })), a[i.selectors.filter] = a[i.selectors.filter] === e ? 1 : a[i.selectors.filter] + 1, r[i.selectors.sort] = r[i.selectors.sort] === e ? 1 : r[i.selectors.sort] + 1, i._execAction("_bindHandlers", 1)
            },
            _processClick: function(i, a) {
                ...
                if (r._execAction("_processClick", 0, arguments), !r._mixing || r.animation.queue && r._queue.length < r.animation.queueLimit) {
                    ...
                    if ("filter" === a) {
                        ...
                        r.controls.toggleFilterButtons ? (r._buildToggleArray(), i.hasClass(r.controls.activeClass) ? (n(i, a, !0), o = r._toggleArray.indexOf(l), r._toggleArray.splice(o, 1)) : (n(i, a), r._toggleArray.push(l)), r._toggleArray = t.grep(r._toggleArray, function(t) {
                            return t
                        }), r._toggleString = r._toggleArray.join(c), r.filter(r._toggleString)) : i.hasClass(r.controls.activeClass) || (t(r.selectors.filter).removeClass(r.controls.activeClass), n(i, a), r.filter(l))
                    }
            ...
            _buildToggleArray: function() {
                ...
                if (t._execAction("_buildToggleArray", 0, arguments), "or" === t.controls.toggleLogic) t._toggleArray = e.split(",");
                    ...
                    for (var i, a = 0; i = t._toggleArray[a]; a++) t._toggleArray[a] = "." + i
                }
            ...
            _updateControls: function(i, a) {
                ...
                for (var l = 0; l < 2; l++)(o = r.controls.live ? t(r.selectors[s]) : r["_$" + s + "Buttons"]) && function(t, e) {
                    try {
                        a && "filter" === s && !("none" === n.filter || "" === n.filter) ? t.filter(e).addClass(r.controls.activeClass) : t.removeClass(r.controls.activeClass).filter(e).addClass(r.controls.activeClass)
                    } catch (i) {}
                }(o, "[data-" + s + '="' + n[s] + '"]'), s = "sort";
            ...
            _buildState: function(t) {
                var e = this,
                    i = {};
                if (e._execAction("_buildState", 0), i = {
                    ...
                    }, t) return e._execFilter("_buildState", i);
            ...
            _setInter: function() {
                this._execAction("_setInter", 0), this._changingLayout && this.animation.animateChangeLayout ? (this._$toShow.css("display", this._newDisplay), this._changingClass && this._$container.removeClass(this.layout.containerClass).addClass(this._newClass)) : this._$toShow.css("display", this.layout.display), this._execAction("_setInter", 1)
            },
            ...
            _setFinal: function() {
                this._execAction("_setFinal", 0), this._sorting && this._printSort(), this._$toHide.removeStyle("display"), this._changingLayout && this.animation.animateChangeLayout && this._$pre.css("display", this._newDisplay), this._execAction("_setFinal", 1)
            },
            ...
            _targetDone: function() {
                this._execAction("_targetDone", 0), this._targetsDone++, this._targetsDone === this._targetsBound && this._cleanUp(), this._execAction("_targetDone", 1)
            },
            _cleanUp: function() {
                var e = this,
            ...
            _parseInsertArgs: function(e) {
                for (var i = {
                    ...
                    var r = e[a];
                    "number" == typeof r ? i.index = r : "object" == typeof r && r instanceof t ? i.$object = r : "object" == typeof r && this._helpers._isElement(r) ? i.$object = t(r) : "object" == typeof r && null !== r ? i.multiMix = r : "boolean" != typeof r || r ? "function" == typeof r && (i.callback = r) : i.multiMix = !1
                }
            ...
            _execFilter: function(t, e, i) {
                if (!(!this._filters.isEmptyObject && this._filters.hasOwnProperty(t))) return e;
            ...
            setOptions: function(e) {
                this._execAction("setOptions", 0, arguments), "object" == typeof e && t.extend(!0, this, e), this._execAction("setOptions", 1, arguments)
            },
            getState: function() {
